    ...
    >
      ...
      <div className="bg-[#1a3a1a] border-b border-[#25D366]/20">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-center sm:text-right">
            ...
            <p className="font-arabic text-sm text-ivory-200/60 mt-0.5">
              تواصل معنا مباشرة عبر واتساب للحصول على توصية مخصصة
            </p>
          </div>
          <a
            href={WA_LINK}
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-10">
          ...
          <div>
            <div className="mb-4">
              <h3 className="font-display text-2xl font-bold text-white">{storeInfo.name}</h3>
            ...
            <p className="font-arabic text-sm text-ivory-200/65 leading-relaxed mb-5">
              صابون طبيعي مصنوع يدويًا بمكونات خالصة من الطبيعة.
              نؤمن بأن جمالك يستحق أفضل ما أنتجته الأرض.
            </p>
          ...
          {/* Quick links */}
          <div>
            <h4 className="font-display text-sm font-semibold text-white mb-5">روابط سريعة</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-display text-sm font-semibold text-white mb-5">تواصل معنا</h4>
            <ul className="flex flex-col gap-3.5">
              ...
              <li>
                ...
                >
                  <span className="w-7 h-7 rounded-lg bg-[#25D366]/20 flex items-center justify-center
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <p className="font-arabic text-xs text-ivory-200/35">
            صُنع بـ 💚 للطبيعة والجمال الحقيقي
          </p>
        </div>
      </div>
    </footer>
