...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-lg mx-auto px-4 h-[60px] flex items-center justify-between relative">
          <button
          ...
          <a
            href="#hero"
            className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center justify-center leading-none group text-center max-w-[170px]"
            aria-label={storeInfo.name}
          >
            <span className="font-display text-lg sm:text-xl font-semibold text-olive-700 group-hover:text-olive-600 transition-colors truncate max-w-full">
              {storeInfo.name}
            </span>
            <span className="text-[9px] font-arabic text-charcoal-400 tracking-[0.18em] uppercase mt-0.5">
              Natural Soap
            </span>
          </a>
      ...
      >
        ...
        <nav
          ...
          className={`absolute top-0 right-0 h-full w-72 max-w-[88vw] bg-ivory-100 shadow-modal
        ...
        >
          ...
          <div className="mb-8 pb-6 border-b border-ivory-300">
            ...
            <p className="font-arabic text-sm text-charcoal-400 mt-1 leading-relaxed">
              {storeInfo.tagline}
            </p>
          </div>
          ...
          <ul className="flex flex-col gap-2">
            {navLinks.map((link, i) => (
              <li key={link.href}>
                ...
                >
                  <span
                    className="w-1.5 h-1.5 rounded-full bg-olive-400 flex-shrink-0"
                    aria-hidden="true"
                  />
                  {link.label}
                </a>
